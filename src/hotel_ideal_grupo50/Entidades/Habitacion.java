...
public class Habitacion {
    ...
    public Habitacion(int idHabitacion, int numHabitacion, Tipo_Habitacion tpo_Habitacion, int piso, boolean estado) {
    ...
    public String toString() {
        return "habitacion{" + "idHabitacion=" + idHabitacion + ", numHabitacion=" + numHabitacion + ", tpo_Habitacion=" + tpo_Habitacion + ", piso=" + piso + ", estado=" + estado + '}';
    }
